    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            If (sdr.Read() = True) Then
                ...
                acsconn.ConnectionString = "Data Source=BUSYBEE-ARVI-PC\SQLEXPRESS;Initial Catalog=payroll_db;User ID=sa;Password=mainpass;MultipleActiveResultSets=True"
                Dim cmdLs As SqlCommand = New SqlCommand("SELECT * FROM tbl_AttPayroll WHERE emp_id = '" + TextBox1.Text + "' AND att_date = '" & Date.Now.ToString("M/dd/yyyy") & "'", acsconn)
                acsconn.Open()
                ...
                ElseIf (sdrLs.Read() = False) Then
                    ...
                    Try
                        ...
                        Dim SqlQuery As String = "INSERT INTO tbl_AttPayroll ([emp_id],[att_date],[time_in],[time_out],[reg_hr],[OT],[ND],[status]) VALUES ('" + TextBox1.Text + "','" + Date.Now.ToString("yyyy-m-dd") + "','" + Label3.Text + "','" + "none" + "','" + "0" + "','" + "0" + "','" + "0" + "','" + "0" + "')"
                        With SqlCommand
