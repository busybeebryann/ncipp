...
Public Class employeelist
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            Dim SqlQuery As String = "UPDATE tbl_user SET job_pos='" + position.Text + "',dept='" + department.Text + "',date_hired='" + dh.Text + "',emp_id='" + ei.Text + "',TAX='" + tn.Text + "',SSS='" + ss.Text + "',philhealth='" + ph.Text + "',pagibig='" + pi.Text + "'  WHERE emp_id='" + DataGridView1.CurrentCell.Value + "'"
            SqlQuery = "UPDATE tbl_logindetails SET pass_word='" + pass.Text + "' WHERE emp_id='" + DataGridView1.CurrentCell.Value + "'"
            With SqlCommand
