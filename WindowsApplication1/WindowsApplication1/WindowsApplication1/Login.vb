...
Public Class Login
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim con As New SqlConnection("Data Source=MASAGCAFAMILY\SQLEXPRESS;Initial Catalog=payroll_db;User ID=sa;Password=mainpass")
        ...
        '  If a = 3 Then
        'a = 0
        ' MsgBox("Account locked. Please inform the Administrator.", MsgBoxStyle.Exclamation, "NCIP-CAR")
        ' Dim SqlQuery As String = "UPDATE tbl_logindetails SET acc_locked='" + "1" + "' WHERE emp_id='" + TextBox1.Text + "'"
