...
Public Class Payroll_computation
    ...
    Private Sub Payroll_computation_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            acsconn.ConnectionString = "Data Source=MASAGCAFAMILY\SQLEXPRESS;Initial Catalog=payroll_db;User ID=sa;Password=mainpass"
            acsconn.Open()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        NH = Val(T1.Text) * Val(Label33.Text)
        OT = Val(T2.Text) * OTval
        ND = Val(T3.Text) * NDval
        ...
        gross = Val(gross)
        loansDed = Val(emL) + Val(cnL) + Val(plL)

        gross = gross - loansDed
        ...
        taxable = taxable - (tax + Val(phL) + Val(pgL))
    ...
    Public Sub savedata()
        ...
        Try
            Dim provider As String = "Data Source=MASAGCAFAMILY\SQLEXPRESS;Initial Catalog=payroll_db;User ID=sa;Password=mainpass"
            ...
            Dim SqlQuery As String = "INSERT INTO [tbl_payroll] ([emp_id],[emp_name],[position],[department],[daterange],[civil_stat],[dependents],[rate_day],[rate_hour],[NH],[OT],[ND],[Grosspay],[SSS],[Philhealth],[Pagibig],[TAX],[net_pay],[status],[date_computed],[time_computed],[month_computed]) VALUES ('" + Label29.Text.Trim + "','" + Label15.Text.Trim + "','" + Label9.Text.Trim + "','" + Label23.Text.Trim + "','" + Label17.Text.Trim + "','" + Label44.Text.Trim + "','" + Label45.Text.Trim + "','" + Label31.Text.Trim + "','" + Label33.Text.Trim + "','" + Label27.Text.Trim + "','" + Label36.Text.Trim + "','" + Label39.Text.Trim + "','" + Label10.Text.Trim + "','" + Label11.Text.Trim + "','" + Label12.Text.Trim + "','" + Label13.Text.Trim + "','" + Label41.Text.Trim + "','" + Label14.Text.Trim + "','0','" + datenow + "','" + TimeOfDay + "','" + mnow + "')"
            With SqlCommand
