    ...
    Public Sub insert()
        If (ei.Text <> "" And fn.Text <> "" And ln.Text <> "" And mi.Text <> "" And gender <> "" And bd.Text <> "" And lblage.Text <> "Please Select Birthdate." And cn.Text <> "" And em.Text <> "" And add.Text <> "" And position.Text <> "" And department.Text <> "" And dh.Text <> "" And ms.Text <> "" And dp.Text <> "" And ss.Text <> "" And ph.Text <> "" And pi.Text <> "" And tn.Text <> "") Then
            Try
                ...
                Dim SqlQuery As String = "INSERT INTO tbl_user ([emp_id],[first_name],[last_name],[middle_name],[gender],[b_date],[age],[c_no],[email],[address],[job_pos],[dept],[date_hired],[marital_status],[dependents],[SSS],[philhealth],[pagibig],[TAX],[hr_pr_day],[basic_pay]) VALUES ('" + ei.Text + "','" + fn.Text + "','" + ln.Text + "','" + mi.Text + "','" + gender + "','" + bd.Text + "','" + lblage.Text + "','" + cn.Text + "','" + em.Text + "','" + add.Text + "','" + position.Text + "','" + department.Text + "','" + dh.Text + "','" + ms.Text + "','" + dp.Text + "','" + ss.Text + "','" + ph.Text + "','" + pi.Text + "','" + tn.Text + "','" + ComboBox1.Text + "','" + Bpay.Text + "')"
                With SqlCommand
