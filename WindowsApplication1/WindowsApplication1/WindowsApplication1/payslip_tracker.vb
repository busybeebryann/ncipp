...
Public Class payslip_tracker
    ...
    Dim SQL As String = ""
    Private Sub payslip_tracker_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        dtgv()
        drange()
    End Sub
    Public Sub dtgv()
        ...
        Try
            SQL = "SELECT * FROM tbl_payroll WHERE emp_id='" + Login.TextBox1.Text.Trim + "' AND [daterange] LIKE '%" + ComboBox1.Text.Trim + "%'"
            Label6.Text = SQL
            conn.Open()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            While (acsdr.Read())
                ...
                ListBox13.Items.Add(acsdr("Grosspay"))
                ListBox14.Items.Add(acsdr("SSS"))
                ListBox15.Items.Add(acsdr("Philhealth"))
                ListBox16.Items.Add(acsdr("Pagibig"))
                ListBox17.Items.Add(acsdr("TAX"))
                ListBox18.Items.Add(acsdr("net_pay"))
                ListBox19.Items.Add(acsdr("additional_deductions"))
                ListBox20.Items.Add(acsdr("status"))
                ListBox21.Items.Add(acsdr("date_computed"))
                ListBox22.Items.Add(acsdr("month_computed"))
                ListBox23.Items.Add(acsdr("time_computed"))
            End While
            acscmdr.Dispose()
            acsdr.Close()
            acsconn.Close()
        ...
        For t_index As Integer = 0 To ListBox1.Items.Count - 1
            ...
            Dim gp As String = CStr(ListBox13.Items(t_index)).Trim
            Dim ss As String = CStr(ListBox14.Items(t_index)).Trim
            Dim ph As String = CStr(ListBox15.Items(t_index)).Trim
            Dim pa As String = CStr(ListBox16.Items(t_index)).Trim
            Dim tx As String = CStr(ListBox17.Items(t_index)).Trim
            Dim np As String = CStr(ListBox18.Items(t_index)).Trim
            Dim ad As String = CStr(ListBox19.Items(t_index)).Trim
            Dim sta As String = CStr(ListBox20.Items(t_index)).Trim
            Dim dc As String = CStr(ListBox21.Items(t_index)).Trim
            Dim mc As String = CStr(ListBox22.Items(t_index)).Trim
            Dim tc As String = CStr(ListBox23.Items(t_index)).Trim
            ...
            Try
                ...
                Dim SqlQuery As String = "INSERT INTO [tbl_payroll] ([ei],[en],[jp],[dp],[dr],[cs],[dps],[rd],[rh],[nh],[ot],[nd],[gp],[ss],[ph],[pa],[tx],[np],[ad],[sta],[dc],[mc],[tc]) VALUES ('" + ei + "','" + en + "','" + jp + "','" + dp + "','" + dr + "','" + cs + "','" + dps + "','" + rd + "','" + rh + "','" + nh + "','" + ot + "','" + nd + "','" + gp + "','" + ss + "','" + ph + "','" + pa + "','" + tx + "','" + np + "','" + ad + "','" + sta + "','" + dc + "','" + mc + "','" + tc + "')"
                With SqlCommand
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Dim paytrack As New payslip_tracker
        paytrack.Show()
        Me.Close()
