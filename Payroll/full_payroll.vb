...
Public Class full_payroll
    ...
    Public Sub dtgv()
        ...
        Try
            SQL = "SELECT * FROM tbl_payroll WHERE [month_computed] LIKE '%" + ComboBox1.Text.Trim + "%'"
            conn.Open()
            ...
            Try
                ...
                Else
                    Try
                        ...
                        Dim SqlQuery As String = "INSERT INTO tbl_payroll_rpt ([mp], [pr], [ts], [gs], [go], [pg], [ph], [tx], [cl], [el], [ml], [pl], [ex], [gl], [hl], [lp], [nl], [nm], [na], [td], [np], [s5], [s0], [ne],[pro],[mo]) VALUES ('" + v1 + "','" + v2 + "','" + v3 + "','" + v4 + "','" + v5 + "','" + v6 + "','" + v7 + "','" + v8 + "','" + v9 + "','" + v10 + "','" + v11 + "','" + v12 + "','" + v13 + "','" + v14 + "','" + v15 + "','" + v16 + "','" + v17 + "','" + v18 + "','" + v19 + "','" + v20 + "','" + v21 + "','" + v22 + "','" + v23 + "','" + v24 + "','" + province + "','" + ComboBox1.Text + "')"
