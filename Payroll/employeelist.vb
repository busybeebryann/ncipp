...
Public Class employeelist
    ...
    Public Sub dtgv()
        ...
        Try
            ...
            SQL = "SELECT emp_id AS Employee_id,first_name +' '+ last_name AS fullname,address,b_date,c_no,TAX,lbp_number,gsis_no,pol_number,bp_number,pagibig,philhealth,date_hired,status from tbl_user WHERE emp_id LIKE '%" + TextBox1.Text + "%'"
            conn.Open()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            End If
            Dim SqlCommand As New SqlCommand
            Dim SqlQuery As String = "UPDATE tbl_logindetails SET user_name='" + ei.Text + "',pass_word='" + pass.Text + "' WHERE user_name='" + DataGridView1.CurrentCell.Value + "'"
            With SqlCommand
                .CommandText = SqlQuery
                .Connection = con
                .ExecuteNonQuery()
