...
Public Class LeaveFiler
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Label37.Text = dtpStartDate.Text
        Label38.Text = Label34.Text

        Label21.Text = cbLeaveType.Text
        Label22.Text = cbNoDays.Text
        Label23.Text = cbNoDayswPay.Text
    End Sub
    ...
    Private Sub DateTimePicker1_ValueChanged(sender As Object, e As EventArgs) Handles dtpStartDate.ValueChanged
        datenow = dtpStartDate.Text
        Label34.Text = datenow.AddDays(Val(cbNoDays.Text) - 1)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Try
            totL = Val(cbNoDays.Text) 'number of days
            countl = Val(cbNoDays.Text) 'number of days
            dateL = dtpStartDate.Text 'start date
            hw = Val(cbNoDayswPay.Text)
        ...
        Try
            ...
            End If
            Dim SqlCommand As New SqlCommand
            Dim SqlQuery As String = "INSERT INTO [tbl_leave] ([emp_id],[leave_type],[no_days],[no_paid],[s_d],[e_d]) VALUES ('" + TextBox1.Text + "','" + cbLeaveType.Text + "','" + cbNoDays.Text + "','" + cbNoDayswPay.Text + "','" + dtpStartDate.Text + "','" + Label34.Text + "')"
