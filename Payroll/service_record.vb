...
Public Class service_record
    ...
    Dim dsServiceRecord As New DataSet
    ...
    Function GetServiceRecord()
        ...
        Try
            ...
            cmd.CommandText = "SELECT * FROM tbl_service_rpt WHERE empid LIKE '%" & objForm.EmpId & "%' "
    ...
    Public Sub PrintPreview()
        ...
        Try
            ...
            rptDocument.Load(Application.StartupPath & "\Reports\ServiceRecord.rpt")
            dsServiceRecord = GetServiceRecord()
            rptDocument.SetDataSource(dsServiceRecord.Tables(0))

            CRsrviwer.ReportSource = rptDocument
    ...
    Public Sub del()
        Try
            ...
            Dim SqlQuery As String = "DELETE FROM tbl_service_rpt"
            With SqlCommand
