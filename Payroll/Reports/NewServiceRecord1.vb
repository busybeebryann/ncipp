...
Public Class NewServiceRecord
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.NewServiceRecord.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNewServiceRecord
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NewServiceRecord = New NewServiceRecord()
        rpt.Site = Me.Site
        Return rpt
    End Function
